...
export const DashboardSidebar: React.FC<DashboardSidebarProps> = ({ onClose }: DashboardSidebarProps) => {
    return (
        <aside className="h-full w-64 border-r border-(--border) bg-(--surface) flex flex-col">
            ...
            <div className="p-4 mt-auto">
                ...
                <div className="mt-4 p-4 border border-(--border) rounded-2xl bg-white/5">
                    <p className="text-[10px] text-(--muted) uppercase font-bold tracking-widest mb-2">Network</p>
